...
| `utc_offset_ordering_3a60ceb_1` | `property_utc_offset_ordering` | `witness_utc_offset_ordering_case_neg_pos`, `witness_utc_offset_ordering_case_negative_hour_positive_hour`, `witness_utc_offset_ordering_case_negative_zero`, `witness_utc_offset_ordering_case_utc` |
...
- **Witness(es)**: `witness_utc_offset_ordering_case_neg_pos`, `witness_utc_offset_ordering_case_negative_hour_positive_hour`, `witness_utc_offset_ordering_case_negative_zero`, `witness_utc_offset_ordering_case_utc`
